...
public class FifthActivity extends ActionBarActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getAllWidgets();
        sQLiteHelper = new SQLiteHelper(FifthActivity.this);
    ...
    private void onAddRecord() {
        Intent intent = new Intent(FifthActivity.this, TableManipulationActivity.class);
                        ...
                        builder.setItems(items, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                if (which == 0) {
                                    ...
                                    AlertDialog.Builder deleteDialogOk = new AlertDialog.Builder(FifthActivity.this);
